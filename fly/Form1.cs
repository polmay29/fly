...
namespace TravelApp
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeCityData()
        {
            ...
            {
                { "Москва", new List<string> { "Птичье молоко", "Эскимо", "Щи", "Холодец", "Кулебяка" } },
                ...
                { "Владикавказ", new List<string> { "Осетинские пироги", "Лывжа", "Цæппар" } },
                ...
                { "Могилёв", new List<string> { "Мачанка", "Фаршированные куриные ножки с цибриками", "Завиванцы с яблоками и корицей"} },
        ...
        {
            string fromCity = CapitalizeCity(comboBoxFrom.SelectedItem?.ToString());
            string toCity = CapitalizeCity(comboBoxTo.SelectedItem?.ToString());
        ...
        private string GetDirectRoute(string fromCity, string toCity)
        {
            ...
            result += $" *Рекомендуемые блюда:** {dishes}.\n\n";
            return result;
        }
